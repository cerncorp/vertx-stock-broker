...
import com.example.starter.quotes.GetQuotesFromDatabaseHandler;
...
public class GetWatchListFromDatabaseHandler implements Handler<RoutingContext> {
  ...
  public static final Logger LOG = LoggerFactory.getLogger(GetWatchListFromDatabaseHandler.class);
